...
//    { TIPO_NEMICO_ARCIERE_STATICO,          ATTRIBUTO_AIM, 1200, DIR_RIGHT, 240 },
 ...
 //   { TIPO_NEMICO_MORTAIO,       ATTRIBUTO_NO,  240, DIR_LEFT,  120 },
    { TIPO_NEMICO_BLOB_PATTUGLIATORE,       ATTRIBUTO_NO,  60, DIR_LEFT,  120 },
//    { TIPO_NEMICO_BLOB_PATTUGLIATORE,       ATTRIBUTO_NO,  80, DIR_LEFT,  120 },
  //  { TIPO_NEMICO_BLOB_PATTUGLIATORE,       ATTRIBUTO_NO,  100, DIR_LEFT,  120 },
    //{ TIPO_NEMICO_BLOB_PATTUGLIATORE,       ATTRIBUTO_NO,  120, DIR_LEFT,  120 },
};
