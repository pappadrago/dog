...
static constexpr door_info s1_doors[] =
{
    ...
    {   16, 448,           1,         1 },   // porta 0 -> porta 1 (stesso schema, per provare)
    {  1536, 432,           1,         0 },   // porta 1 -> porta 0
};
...
bn::regular_bg_ptr create_schema_bg0(int schema)
{
    switch (schema)
    {
    // case 2: return bn::regular_bg_items::bg_XXX.create_bg(0);
    case 1:
    default:
...
bn::regular_bg_ptr create_schema_bg1(int schema)
{
    switch (schema)
    {
    // case 2: return bn::regular_bg_items::bg_XXX.create_bg(1);
    case 1:
    default:
